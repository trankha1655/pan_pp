...
class PAN_PP_IC15(data.Dataset):
    def __init__(self,
        ...
        if split == 'train':
            data_dirs = [ vin_train_data_dir]
            gt_dirs = [vin_train_gt_dir]
        elif split == 'test':
            data_dirs = [vin_test_data_dir]
            gt_dirs = [vin_test_gt_dir]
        else:
        ...
        for data_dir, gt_dir in zip(data_dirs, gt_dirs):
            ...
            if count ==1:
                ...
                print('Found {} images,gt in {}'.format((len(img_paths)), data_dir))
